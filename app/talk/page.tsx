...
{
  "score": <رقم من 0 إلى 100 يعبر عن صحة لغة الطالب وقواعده>,
  "highlightedCorrected": "<النص الذي كتبه الطالب مع وضع الكلمات الخاطئة التي تم تصحيحها داخل <span> باللون الأخضر. مثال: <span style='color:#22C55E;font-weight:bold'>iyiyim</span> sen?>",
  "alternative": "<جملة تركية بديلة وممتازة كخيار أفضل للقول، بدون أي ترجمة>",
  "reply": "<ردك كمدرس باللغة التركية فقط بدون أي عربي أو إنجليزي>"
}
إذا كان النص صحيحاً تماماً، اجعل highlightedCorrected مطابقاً للنص الأصلي، و score يساوي 100.`;
